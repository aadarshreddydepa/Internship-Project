...
var NgDropdownPanelComponent = class _NgDropdownPanelComponent {
  ...
  _handleScroll() {
    this._zone.runOutsideAngular(() => {
      (0, import_rxjs.fromEvent)(this.scrollElementRef.nativeElement, "scroll").pipe((0, import_operators.takeUntil)(this._destroy$), (0, import_operators.auditTime)(0, SCROLL_SCHEDULER)).subscribe((e) => {
  ...
  _handleOutsideClick() {
    ...
    this._zone.runOutsideAngular(() => {
      (0, import_rxjs.merge)((0, import_rxjs.fromEvent)(this._document, "touchstart", {
        capture: true
      }), (0, import_rxjs.fromEvent)(this._document, "click", {
        capture: true
      })).pipe((0, import_operators.takeUntil)(this._destroy$)).subscribe(($event) => this._checkToClose($event));
    });
  }
  _checkToClose($event) {
  ...
  _setupMousedownListener() {
    this._zone.runOutsideAngular(() => {
      (0, import_rxjs.fromEvent)(this._dropdown, "mousedown").pipe((0, import_operators.takeUntil)(this._destroy$)).subscribe((event) => {
...
var NgOptionComponent = class _NgOptionComponent {
  constructor(elementRef) {
    ...
    this.disabled = false;
    this.stateChange$ = new import_rxjs.Subject();
  }
  get label() {
...
var NgSelectComponent = class _NgSelectComponent {
  constructor(classes, autoFocus, config, newSelectionModel, _elementRef, _cd, _console) {
    ...
    this._destroy$ = new import_rxjs.Subject();
    this._keyPress$ = new import_rxjs.Subject();
    this._items = [];
  ...
  _setItemsFromNgOptions() {
    ...
    const handleOptionChange = () => {
      const changedOrDestroyed = (0, import_rxjs.merge)(this.ngOptions.changes, this._destroy$);
      (0, import_rxjs.merge)(...this.ngOptions.map((option) => option.stateChange$)).pipe((0, import_operators.takeUntil)(changedOrDestroyed)).subscribe((option) => {
    ...
    this.ngOptions.changes.pipe((0, import_operators.startWith)(this.ngOptions), (0, import_operators.takeUntil)(this._destroy$)).subscribe((options) => {
  ...
  _handleKeyPresses() {
    ...
    this._keyPress$.pipe((0, import_operators.takeUntil)(this._destroy$), (0, import_operators.tap)((letter) => this._pressedKeys.push(letter)), (0, import_operators.debounceTime)(200), (0, import_operators.filter)(() => this._pressedKeys.length > 0), (0, import_operators.map)(() => this._pressedKeys.join(""))).subscribe((term) => {
